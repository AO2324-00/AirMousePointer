...
from HandGesture import switchDirection, handGestureRecognition
...
while cap.isOpened():
    ...
    #print(switchDirection(landmarks.hands.right))
    #handGestureRecognition(landmarks.hands.right)
    print(handGestureRecognition(landmarks.hands.right))
